...
import { SYS_RESEARCH, SYS_SOLUTION, SYS_EXPORT } from './lib/prompts';
...
export default function App() {
  ...
  const handleReset = () => {
    ...
    setMaterials(null); setRoiTouched(false);
  ...
  return (
    <div style={{ fontFamily: "'IBM Plex Sans', system-ui, sans-serif", background: BG, minHeight: '100vh' }}>
      <NavBar mode={mode} setMode={setMode} step={step} setStep={setStep} />
      <div style={{ maxWidth: 880, margin: '0 auto', padding: '24px 18px 60px' }}>
        {mode === 'intel' && (
          <>
            ...
            {step === 4 && <StepExport form={form} solution={solution} materials={materials} roi={roi} roiTouched={roiTouched} setStep={setStep} onReset={handleReset} />}
          </>
        )}
